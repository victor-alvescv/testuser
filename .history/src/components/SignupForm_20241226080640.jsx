        ...
        (
          ...
          <Fieldset.Root size="lg" maxW="md" invalid>
            <h1>Create your account</h1>
                <Fieldset.Content className='form' invalid={!formValid}>
                   <Field color='white' label="Email address" invalid={!!emailError}>
                      <Input
                      color="white"
                    ...
                    background='gray.focusRing'
                    required  />
                    {passwordError && <Fieldset.ErrorText>{passwordError}</Fieldset.ErrorText>}
                </Fieldset.Content>
                  <Button 
