...
const CartItem = ({movieOb, remove, changeQuantity} ) => {
    ...
    return (
        <div className='cart__item--wrapper'>
            ...
            <div className="cart__item--quantity">
                <input type="number" id="quantity" value={quantity} name="quantity" min="1" max="99" onChange={(event) => changeQuantity(event.target.value, setQuantity={setQuantity}, movieOb={movieOb})} />
            </div>
