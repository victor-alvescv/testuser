import { Button, Field, Fieldset, FieldsetContent, Input } from '@chakra-ui/react';
...
const SignForm = ({signedIn, passErrorMessage, emailErrorMessage, setEmail, signin, setPassword}) => {
    ...
    <FieldsetContent.Root size="lg" maxW="md" invalid={passErrorMessage || emailErrorMessage}>
