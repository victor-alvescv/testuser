...
const CartCheckout = ({cart, setCart}) => { 
    ...
    function changeQuantity(value, setQuantity, movieOb) {
        const subTotalValue = () => {cart.reduce((acc, item) => acc + item.quantity * item.price, 0)};
    ...
    return (
        <div className="checkout">
            ...
            <Link to="/search">
                    ...
                    {cart.map((item) => (
                        <CartItem movieOb={item} remove={removeCartItem} changeQuantity={changeQuantity}/>
                    ))
