...
(
    ...
    <div className="movie__description__wrapper">
                            ...
                            onClick={() =>{ 
                                 setAdded(true)
                                setCart((prevCart) => {
                                movieExists = prevCart.find((item) => item.movie.imdbID === movie.imdbID)    
                                if (movieExists) {
                                return prevCart.map((item) => 
                                    item.movie.imdbID === movie.imdbID ? {...item, quantity: item.quantity + 1}
                                )
                                    [...prevCart, {movie, quantity: 1, price: price}]
                                }
