            ...
            <div className="search__header--title">
                ...
                <div className="searchbar__wrapper">
                    ...
                    <div className="search__type--wrapper">
                        <u00tton className='search__type-button'>All</button>
                        <u00tton className='search__type-button'>Movies</button>
                        <u00tton className='search__type-button'>Series</button>
                    </div>
            </div>
