...
const Signin = () => {
  ...
  .catch((error) => {
    ...
    useEffect(() => {
      ...
      document.body.style.background = "url('C:\Users\josep\Cinema_Library-Clone\Cinema_Library-React\Cinema_Library-React\src\assets\movie_collage.png') no-repeat center center fixed";
