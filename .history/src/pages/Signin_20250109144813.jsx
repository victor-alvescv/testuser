...
const Signin = () => {
  ...
  .catch((error) => {
    ...
    useEffect(() => {
      ...
      document.body.style.background = "url('https://www.poconorecord.com/gcdn/authoring/2012/08/05/NPOR/ghows-PR-461e3194-4865-41fb-828f-a88ef3fbadc9-5371e818.jpeg?width=660&height=440&fit=crop&format=pjpg&auto=webp') no-repeat center center fixed";
