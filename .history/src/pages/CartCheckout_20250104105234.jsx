...
const CartCheckout = ({cart, setCart, set}) => { 
...
useEffect(() => {
    ...
    if (cart.length > 0) {
        ...
        const totalQuant = cart.reduct((acc, item) => acc + item.quantity)
    ...
    return (
        <div className="checkout">
            ...
            <Link to="/search">
                    ...
                    {cart.map((item) => (
                        <CartItem movieOb={item} remove={removeCartItem} cart={cart} setCart={setCart}/>
                    ))
