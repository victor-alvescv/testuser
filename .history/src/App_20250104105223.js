...
function AppContent() {
  ...
  const [totalCartQuant, setTotalCartQuant] = useState();
  ...
  <div className={showBackground ? "background_container" : ''}>
    ...
    <div className="App">
      <Routes>
        ...
        <Route path='/cart' element={<CartCheckout cart={cartValue} setCart={setCartValue} setTotalQuant={set}/>} />
      </Routes>
    </div>
      </div>
    <Footer/>
